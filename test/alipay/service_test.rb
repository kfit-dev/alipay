...
class Alipay::ServiceTest < Minitest::Test
  ...
  def test_generate_create_direct_pay_by_user_url
    ...
    assert_equal "#{Alipay.legacy_gateway_url}/gateway.do?service=create_direct_pay_by_user&_input_charset=utf-8&partner=1000000000000000&seller_id=1000000000000000&payment_type=1&out_trade_no=1&subject=test&price=0.01&quantity=1&sign_type=MD5&sign=682ad02280fca7d4c0fd22678fdddeef", Alipay::Service.create_direct_pay_by_user_url(options)
  end
  ...
  def test_refund_fastpay_by_platform_pwd_url
    ...
    assert_equal "#{Alipay.legacy_gateway_url}/gateway.do?service=refund_fastpay_by_platform_pwd&_input_charset=utf-8&partner=1000000000000000&seller_user_id=1000000000000000&refund_date=2015-01-01+00%3A00%3A00&batch_num=1&detail_data=1%5E0.01%5Etest&batch_no=123456789&notify_url=%2Fsome_url&sign_type=MD5&sign=def57a58e1ac21f70c45e41bd3697368", Alipay::Service.refund_fastpay_by_platform_pwd_url(options)
  end
  ...
  def test_generate_create_forex_trade_url
    ...
    assert_equal "#{Alipay.legacy_gateway_url}/gateway.do?service=create_forex_trade&_input_charset=utf-8&partner=1000000000000000&notify_url=https%3A%2F%2Fexample.com%2Fnotify&subject=test&out_trade_no=1&currency=EUR&total_fee=0.01&sign_type=MD5&sign=f24fd4d76acabf860263a40805138380", Alipay::Service.create_forex_trade_url(options)
  end
  ...
  def test_create_forex_trade_wap_url
    ...
    assert_equal "#{Alipay.legacy_gateway_url}/gateway.do?service=create_forex_trade_wap&_input_charset=utf-8&partner=1000000000000000&seller_id=1000000000000000&out_trade_no=20150401000-0001&subject=Order+Name&merchant_url=http%3A%2F%2Fexample.com%2Fitemback&total_fee=10.00&currency=USD&return_url=https%3A%2F%2Fexample.com%2Forders%2F20150401000-0001&notify_url=https%3A%2F%2Fexample.com%2Forders%2F20150401000-0001%2Fnotify&sign_type=MD5&sign=f15d9e3d885c12f1a994048342c07bef", Alipay::Service.create_forex_trade_wap_url(options)
  end
  ...
  def test_acquirer_overseas_query
    ...
    assert_equal "#{Alipay.legacy_gateway_url}/gateway.do?service=alipay.acquire.overseas.query&_input_charset=utf-8&partner=1000000000000000&partner_trans_id=2010121000000002&sign_type=MD5&sign=2a7f598bbb13d02f7de819ae689f80ba", Alipay::Service.acquirer_overseas_query(params)
  end
